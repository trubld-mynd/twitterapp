...
$startmessages = ["Hi there...",
    "Welcome to Snakes N Ladders Pub Quest! I am the Pub Questbot. Tweet me your drink count at each pub (max 4) AND A PHOTO", 
       ...
       "I'm only awake every 30 mins. Make sure your tweet to me is the last thing you tweet to anyone before I wake, or I'll give you a roll of 1.",
...
every(30.minutes, 'Queueing twitter-tweet') { Delayed::Job.enqueue TwitterTweet.new }
